 ...
 * String $isbn, $titulo, $editorial, $nombre, $apellido, $arregloLibros, $libro, $otro, $isbnLibro
 * String $pEditorial, $isbnLibro2, $liabroABuscar, $editorialABuscar, $arraySegunEditorial
 * boolean $terminar, $datosCargados, $seEncuentra, $libroEncontrado, $libroEncontrado2
 * int $cant, $anioEdicion, $i, $cantAnios
 */
$terminar = false;
$datosCargados = false;
$arregloLibros = array();
    ...
    switch($opcion) {
        case 1:
            ...
            do {
                ...
                $libro = new Libro($isbn, $titulo, $anio, $editorial, $nombre, $apellido);
